...
Este é um projeto focado na criação de um serviço de contabilidade. O serviço foi projetado com uma API REST integrando autenticação, autorização e lógica de negócios relacionada às práticas contábeis.
...
- POST /api/acct/payments: adicionar um lote de pagamentos
- PUT /api/acct/payments: atualizar um pagamento específico
...
- GET /api/empl/payment: obter um pagamento para um funcionário por um período específico ou obter todos os pagamentos se nenhum período for especificado
